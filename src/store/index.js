...
const store = createStore({
  ...
  mutations: {
    setNewProductInProductList(state, productData) {
    ...
    setProductListWithoutDeletedUProduct(state, idToDelete) {
      state.productList = state.productList.filter(
        (item) => item.id !== idToDelete
      );
    },
    setNewProductsData(state, product) {
  ...
  actions: {
    addNewProduct({ commit }, product) {
      commit("setNewProductInProductList", product);
    },
    deleteProduct({ commit }, IdToDelete) {
      commit("setProductListWithoutDeletedUProduct", IdToDelete);
    },
    updateProduct({ commit }, product) {
      commit("setNewProductsData", product);
    },
  },
});
